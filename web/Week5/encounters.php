...
document.addEventListener("DOMContentLoaded" , ()=>{
  ...
  function addPlayersEncounter(){
    ...
    for (i = 0; i < playersFight.length; i++){
        ...
        document.getElementById("activePlayersEncounter").innerHTML += "<p class = 'lists' id = 'activePlayersEncounter' style='order = " + displayArray[i] + " '> <span class='badge'> " + displayArray[i] + "</span>" + playersFight[i] + "</p>";
