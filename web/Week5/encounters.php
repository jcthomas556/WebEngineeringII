...
document.addEventListener("DOMContentLoaded" , ()=>{
  ...
  function addPlayersEncounter(){
    ...
    for (i = 0; i < playersFight.length; i++){
        ...
        document.getElementById("activePlayersEncounter").innerHTML += "<p class = 'lists activePlayersEncounter' id = 'defaultList' style='order : " + displayArray[i] + " '> <span class='badge' id='spanSpacing'> " + displayArray[i] + "</span>" + playersFight[i] + "</p>";
